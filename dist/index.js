...
var xml2jsSource = __importStar(require("xml2js"));
var processors_1 = require("xml2js/lib/processors");
    ...
    return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, xml2jsPromise(xml, {
                            async: true,
                            trim: true,
                            explicitArray: false,
                            attrkey: 'attributes',
                            tagNameProcessors: [processors_1.stripPrefix],
                            attrNameProcessors: [processors_1.stripPrefix],
    ...
    return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    parsedJson = _a.sent();
                    return [2 /*return*/, renderer_1.default.renderToStream(renderer_2.default(parsedJson, options))];
                case 2:
                    error_3 = _a.sent();
